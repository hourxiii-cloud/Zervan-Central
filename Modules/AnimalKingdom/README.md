...
## 5.6 Controlled Sub-Observer Posture

AnimalKingdom remains implemented under `Modules/AnimalKingdom/` and is not moved or deleted.

For 5.6 deployment review, AnimalKingdom may be invoked as a controlled sub-observer pressure layer for synthetic adversarial, fuzz, contradiction, malformed-input, label-inversion, hostile-assumption, and edge-case testing against reviewed datasets, Zervan functions, or function families.

This posture preserves capability while bounding it:
- synthetic only
